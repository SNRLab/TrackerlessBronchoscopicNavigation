...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--log_dir",
                                 type=str,
                                 help="log directory",
                                 default="/code/data2/Models/model_name")
        ...
        self.parser.add_argument("--model_name",
                                 ...
                                 default='') #Write the name of the vairable
        ...
        self.parser.add_argument("--gauss_mask_threshold",
                                 type=float,
                                 help="gauss threshold for masking corrupt pixels",
                                 default=0.7)
        
        self.parser.add_argument("--load_weights_folder",
                                 type=str,
                                 default = '/code/data2/Models/model_name/models/weights_19', # use a pretrained network to improve
